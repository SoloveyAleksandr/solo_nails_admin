...
const MyAccount: FC = () => {
  ...
  const [name, setName] = useState(appState.currentUserInfo.name);
  const [phone, setPhone] = useState(appState.currentUserInfo.phone);
  const [inst, setInst] = useState(appState.currentUserInfo.instagram);
              ...
              <div className={styles.infoListBox}>
                {
                  appState.currentUserInfo.instagram ?
                    <a target={'_blank'} href={appState.currentUserInfo.instagram}>
                      <IconButton
                        variant='outline'
                        colorScheme='whiteAlpha'
                        aria-label='editbtn'
